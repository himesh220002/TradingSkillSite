        ...
        <div className="flex items-center gap-6">
          ...
          {user ? (
            ...
            <div className="flex items-center gap-4">
              <Link
                href="/portal"
                className="hidden sm:block text-sm font-medium text-slate-600 dark:text-slate-300 hover:text-emerald-500 transition-colors"
              >
                Log in
              </Link>
              <Link
                href="/portal"
                className="bg-emerald-600 hover:bg-emerald-500 text-white px-5 py-2.5 rounded-full text-xs font-bold transition-all hover:scale-105 active:scale-95 shadow-lg shadow-emerald-500/20"
              >
                Get Started
              </Link>
            </div>
