...
export default function CommunityManager() {
  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-700">
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6 bg-white dark:bg-slate-900/40 p-8 rounded-[2.5rem] border border-black/5 dark:border-white/5 shadow-sm">
        <div>
      ...
      <div className="grid grid-cols-1 gap-6 pb-20">
        {isLoading ? (
          ...
          filteredMessages.map((msg) => (
            <div key={msg._id} className="group relative bg-white dark:bg-slate-900/40 border border-black/5 dark:border-white/5 rounded-[2.5rem] overflow-hidden hover:shadow-2xl hover:shadow-emerald-500/5 transition-all duration-500">
