    ...
    <div className="space-y-6 pb-20 max-w-[1300px] mx-auto px-4 pt-4">
      ...
      <div className="grid lg:grid-cols-4 gap-6">
        ...
        <div className="lg:col-span-3 space-y-6">
           <div className="p-8 rounded-[2.5rem] bg-white dark:bg-slate-900 border border-black/5 shadow-sm space-y-6">
              <div className="flex items-center justify-between">
           ...
           <div className="p-8 rounded-[2.5rem] bg-white dark:bg-slate-900 border border-black/5 shadow-sm space-y-8">
