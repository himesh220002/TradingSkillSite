  ...
  return (
    <div className="flex flex-col min-h-screen transition-colors duration-300 selection:bg-emerald-500/30">
      ...
      <section className="relative min-h-screen flex flex-col justify-center bg-white dark:bg-slate-950 transition-colors duration-300 overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
          <Image
            ...
            fill
            className="object-cover opacity-100 hidden dark:block brightness-[0.3]"
            priority
          />
               ...
               <div className="space-y-6">
                  <div className="h-32 bg-slate-900/50 rounded-2xl border border-white/5 flex items-center justify-center relative overflow-hidden">
                     ...
                     <div className="absolute inset-0 flex items-center justify-center">
                        <span className="text-4xl font-black text-white tracking-tighter">+$1,245.50</span>
                     </div>
                  </div>
                  <div className="grid grid-cols-2 gap-4">
                     <div className="p-4 rounded-2xl bg-white/5 border border-white/5">
                        <div className="text-[10px] font-black text-slate-500 uppercase tracking-widest mb-1">Win Rate</div>
                        <div className="text-xl font-black text-emerald-400">89.2%</div>
                     </div>
                     <div className="p-4 rounded-2xl bg-white/5 border border-white/5">
                        <div className="text-[10px] font-black text-slate-500 uppercase tracking-widest mb-1">Students</div>
                        <div className="text-xl font-black text-blue-400">1.2k+</div>
                     </div>
                  </div>
               </div>
      ...
      <section className="py-32 bg-slate-50 dark:bg-slate-950 transition-colors duration-300 relative overflow-hidden">
        ...
        <div className="absolute top-1/2 left-0 right-0 h-px bg-gradient-to-r from-transparent via-emerald-500/20 to-transparent -translate-y-1/2 hidden lg:block" />
      </section>
